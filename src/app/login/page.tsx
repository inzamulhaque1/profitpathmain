    ...
    <div className="min-h-[80vh] flex items-center justify-center px-3 sm:px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-gray-500 mt-1">Sign in to your ProfitPath account</p>
        </div>
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-6 space-y-4">
          ...
          <p className="text-center text-sm text-gray-500">
            ...
            <Link href={`/register?callbackUrl=${encodeURIComponent(callbackUrl)}`} className="text-brand-600 hover:text-brand-700 font-medium">
              Sign Up
            </Link>
          </p>
          </form>
